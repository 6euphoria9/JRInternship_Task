...
public class FetchAllPlayersResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FetchAllPlayersResponse)) return false;
        final FetchAllPlayersResponse other = (FetchAllPlayersResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof FetchAllPlayersResponse;
    }
    ...
    public String toString() {
        return "FetchAllPlayersResponse(id=" + this.getId() + ", name=" + this.getName() + ", title=" + this.getTitle() + ", race=" + this.getRace() + ", profession=" + this.getProfession() + ", birthday=" + this.getBirthday() + ", banned=" + this.getBanned() + ", experience=" + this.getExperience() + ", level=" + this.getLevel() + ", untilNextLevel=" + this.getUntilNextLevel() + ")";
    }
}
