...
public class UpdatePlayerRequest {
    ...
    public UpdatePlayerRequest(Long id, String name, String title, Race race, Profession profession, Long birthday, Boolean banned, Integer experience) {
        this.id = id;
        this.name = name;
        this.title = title;
        this.race = race;
    ...
    public boolean equals(final Object o) {
        ...
        final UpdatePlayerRequest other = (UpdatePlayerRequest) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UpdatePlayerRequest;
    }
    ...
    public String toString() {
        return "UpdatePlayerRequest(id=" + this.getId() + ", name=" + this.getName() + ", title=" + this.getTitle() + ", race=" + this.getRace() + ", profession=" + this.getProfession() + ", birthday=" + this.getBirthday() + ", banned=" + this.getBanned() + ", experience=" + this.getExperience() + ")";
    }
}
