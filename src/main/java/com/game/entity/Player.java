...
public class Player {
    ...
    public Player(Long id, String name, String title, Race race, Profession profession, Calendar birthday, Boolean banned, Integer experience, Integer level, Integer untilNextLevel) {
        this.id = id;
        this.name = name;
        this.title = title;
        this.race = race;
    ...
    public String toString() {
        return "Player(id=" + this.getId() + ", name=" + this.getName() + ", title=" + this.getTitle() + ", race=" + this.getRace() + ", profession=" + this.getProfession() + ", birthday=" + this.getBirthday() + ", banned=" + this.getBanned() + ", experience=" + this.getExperience() + ", level=" + this.getLevel() + ", untilNextLevel=" + this.getUntilNextLevel() + ")";
    }
}
